...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/eyup/catkin_ws4/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/eyup/catkin_ws4/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/eyup/catkin_ws4/install)
...
if(NOT "/home/eyup/catkin_ws4/src/mavros/libmavconn/include;/usr/include;/home/eyup/catkin_ws4/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/eyup/catkin_ws4/src/mavros/libmavconn/include;/usr/include;/home/eyup/catkin_ws4/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eyup/catkin_ws4/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
    _list_append_unique(libmavconn_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavconn;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.0.4")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/eyup/catkin_ws4/devel/.private/libmavconn/lib;/home/eyup/catkin_ws4/devel/lib;/home/eyup/catkin_ws3/devel/lib;/home/eyup/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(libmavconn_EXPORTED_TARGETS ${${libmavconn_dep}_EXPORTED_TARGETS})
endforeach()
