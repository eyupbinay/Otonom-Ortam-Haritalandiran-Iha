...
if("TRUE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /home/eyup/catkin_ws4/src/mavros/mavros)
  set(mavros_DEVEL_PREFIX /home/eyup/catkin_ws4/devel/.private/mavros)
  set(mavros_INSTALL_PREFIX "")
  set(mavros_PREFIX ${mavros_DEVEL_PREFIX})
else()
  set(mavros_SOURCE_PREFIX "")
  set(mavros_DEVEL_PREFIX "")
  set(mavros_INSTALL_PREFIX /home/eyup/catkin_ws4/install)
...
if(NOT "/home/eyup/catkin_ws4/src/mavros/mavros/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(mavros_INCLUDE_DIRS "")
  set(_include_dirs "/home/eyup/catkin_ws4/src/mavros/mavros/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eyup/catkin_ws4/src/mavros/mavros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(mavros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavros;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0;/usr/lib/x86_64-linux-gnu/libGeographic.so")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mavros_NUM_DUMMY_TARGETS)
      set(mavros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mavros::wrapped-linker-option${mavros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mavros_NUM_DUMMY_TARGETS "${mavros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mavros::wrapped-linker-option${mavros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mavros_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/eyup/catkin_ws4/devel/.private/mavros/lib;/home/eyup/catkin_ws4/devel/lib;/home/eyup/catkin_ws3/devel/lib;/home/eyup/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mavros_EXPORTED_TARGETS ${${mavros_dep}_EXPORTED_TARGETS})
endforeach()
