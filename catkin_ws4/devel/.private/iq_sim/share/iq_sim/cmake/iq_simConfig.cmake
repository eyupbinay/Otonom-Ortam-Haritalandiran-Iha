...
if("TRUE" STREQUAL "TRUE")
  set(iq_sim_SOURCE_PREFIX /home/eyup/catkin_ws4/src/iq_sim)
  set(iq_sim_DEVEL_PREFIX /home/eyup/catkin_ws4/devel/.private/iq_sim)
  set(iq_sim_INSTALL_PREFIX "")
  set(iq_sim_PREFIX ${iq_sim_DEVEL_PREFIX})
else()
  set(iq_sim_SOURCE_PREFIX "")
  set(iq_sim_DEVEL_PREFIX "")
  set(iq_sim_INSTALL_PREFIX /home/eyup/catkin_ws4/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'iq_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eyup/catkin_ws4/src/iq_sim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/eyup/catkin_ws4/devel/.private/iq_sim/lib;/home/eyup/catkin_ws4/devel/lib;/home/eyup/catkin_ws3/devel/lib;/home/eyup/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(iq_sim_EXPORTED_TARGETS ${${iq_sim_dep}_EXPORTED_TARGETS})
endforeach()
